...
static int calculate_huff_bits(int hufftab_no, int *x_quant, int *x_quant_sign, int offset, int length)
{
    int len_esc;
    int index;
    int bits = 0;
...
int fa_noiseless_huffman_bitcount(int *x_quant, int *x_quant_sign, int sfb_num,  int *sfb_offset,
                                  int *quant_hufftab_no, int *quant_bits)
{
    ...
    for(i = 0; i < sfb_num; i++) {
        ...
        if(max_sfb_quant == 0) {
            quant_bits_best    = calculate_huff_bits(0, x_quant, x_quant_sign, sfb_offset[i], sfb_width);
            ...
            quant_bits_best    = calculate_huff_bits(11, x_quant, x_quant_sign, sfb_offset[i], sfb_width);
            quant_hufftab_best = 11;
        }

        if(max_sfb_quant > 0 && max_sfb_quant < 13) {
            quant_bits1 = calculate_huff_bits(quant_hufftab_no1, x_quant, x_quant_sign, sfb_offset[i], sfb_width);
            quant_bits2 = calculate_huff_bits(quant_hufftab_no2, x_quant, x_quant_sign, sfb_offset[i], sfb_width);
...
int fa_huffman_encode_mdctline(int *x_quant, int *x_quant_sign, int sfb_num, int *sfb_offset, int *quant_hufftab_no,
